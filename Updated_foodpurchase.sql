...
-- correlation between annual income and recency
-- age_group and recency
...
-- insights:
-- the customers who had responded in the targeted campaign but not in any other have reaised zero complaints
